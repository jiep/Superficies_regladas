...
\begin{document}
	...
	\begin{frame}{Conoide de Wallis}
		\begin{columns}[b] % align columns
			...
			\begin{column}{.50\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=0.8\linewidth]{../Imágenes/conoide-de-Wallis-3}
	...
	\begin{frame}{Conoide de Plücker}
		\begin{columns}[b] % align columns
			...
			\begin{column}{.50\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=0.8\linewidth]{../Imágenes/conoide-de-Plucker-n=2-3}
					\caption{Otra vista del conoide de Plücker}
	...
	\begin{frame}{Conoide de Plücker generalizado}
		\begin{columns}[b] % align columns
			...
			\begin{column}{.50\textwidth}
					\begin{figure}
						\centering
						\includegraphics[width=0.8\linewidth]{../Imágenes/conoide-de-Plucker-n=5}
	...
	\begin{frame}{Paraguas de Whitney}
		\begin{columns}[b] % align columns
			...
			\begin{column}{.50\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=0.8\linewidth]{../Imágenes/paraguas-de-whitney-3}
					\caption{Otra vista del paraguas de Whitney}
	...
	\begin{figure}
		\centering
		\animategraphics[width=4in,height=2in,autoplay,controls,loop]{12}{../Imágenes/Banda-de-Moebius/119-}{0}{119}
	...
	\begin{frame}{Hiperboloide}
		\begin{figure}
			\centering
			\animategraphics[width=4in,height=2in,autoplay,controls,loop]{12}{../Imágenes/Hiperboloide-2/Hiperboloid-2-}{0}{22}
	...
	\begin{frame}{Hiperboloide}
		\begin{figure}
			\centering
			\animategraphics[width=4in,height=2in,autoplay,controls,loop]{12}{../Imágenes/Hiperboloide-1/Hiperboloid-1-}{0}{36}
			\caption{Hiperboloide \url{http://visualizingmath.tumblr.com/post/88902245528/parabola-half-a-hyperbola-what-is-that-curve}}
			\label{fig:hiperboloide-2-gif}
		\end{figure}	
	\end{frame}
	
	\begin{frame}{Paraboloide hiprbólico}
		\begin{columns}[t] % align columns
			\begin{column}{.50\textwidth}
				\begin{figure}
					\centering
	...
	\begin{frame}{Paraboloide hiperbólico}
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{../Imágenes/Hyperbolic-paraboloid}
	...
	\begin{frame}{Cola de milano (o Swallowtail)}
		\begin{columns}[t] % align columns
			\begin{column}{.50\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=0.8\linewidth]{../Imágenes/cola-de-milano-1}
	...
	\begin{frame}{Cola de milano (o Swallowtail)}
		\begin{columns}[b] % align columns
			\begin{column}{.50\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=\linewidth]{../Imágenes/cola-de-milano-2}
			...
			\begin{column}{.50\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=0.8\linewidth]{../Imágenes/Aplicaciones/The_Swallowtail}
					\caption{The Swallow's Tail, Salvador Dalí}
	...
	\begin{frame}{Aplicaciones a la arquitectura}	
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{../Imágenes/Aplicaciones/Pengrowth_Saddledome}
	...
	\begin{frame}{Referencias}
		%\nocite{*}
		%\bibliography{../Bibliografía/bibliografia.bib}
	\end{frame}
